...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 SICC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 SICC mininput
/** No amount larger than this (in satoshi) is valid */
/** siccoin to have twice then (10000*20)+(10000*10)+(10000*5) = total coins */
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
	// rate at which blocks are found expressed per difficulty period
	// 5 minutes elapses 288 times in one day
